...
var operators = {
  ...
  coalesce: function (a, b) {
    return this.bound(a) ===  XSD_TRUE ? a : b;
  },
  exists: function (a) {
  ...
  timezone: function (dt) {
    //if (operators.tz(dt) === '""') throw new Error('TIMEZONE requires timezone added to dateTime');

    //var offset = dt.getTimezoneOffset();
    //return operators.stdt(dt.getTimezone(), XSD_DAYTIMEDURATION);
  ...
  md5: function (arg) {
    return crypto.MD5(arg);
  },
  sha1: function (arg) {
    return crypto.SHA1(arg);
  },
  sha256: function (arg) {
    return crypto.SHA256(arg);
  },
  sha384: function (arg) {
    return crypto.SHASHA3(arg);
  },
  sha512: function (arg) {
    return crypto.SHA512(arg);
  },
  // 17.5 XPath Constructor Functions
  'http://www.w3.org/2001/XMLSchema#integer': function (a) {
    if (isDatetime(a)|| isUri(a))
  ...
  'http://www.w3.org/2001/XMLSchema#decimal': function (a) {
    ...
    return operators.strdt(a, XSD + 'decimal');
  },
  ...
  'http://www.w3.org/2001/XMLSchema#boolean': function (a) {
    ...
    return operators.strdt(new Boolean(value), XSD_BOOLEAN);
  },
